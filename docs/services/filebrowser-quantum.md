...
For details about configuring the [Ansible role for FileBrowser Quantum](https://github.com/P3X-118/filebrowser-quantum-ar), you can check them via:
- 🌐 [the role's documentation](https://github.com/P3X-118/filebrowser-quantum-ar/blob/sgc/docs/configuring-filebrowser-quantum.md) online
...
Alternatively, you can enable OIDC authentication for FileBrowser Quantum. See [this section](https://github.com/P3X-118/filebrowser-quantum-ar/blob/sgc/docs/configuring-filebrowser-quantum.md#configuring-oidc-authentication-optional) on the role's documentation for necessary settings.
...
See [this section](https://github.com/P3X-118/filebrowser-quantum-ar/blob/sgc/docs/configuring-filebrowser-quantum.md#troubleshooting) on the role's documentation for details.
