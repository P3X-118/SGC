...
The playbook used to install Docker and the Docker SDK for Python by default, unless you turned these off by setting `sgc_docker_install` and `docker_python_sdk_enabled` (respectively) to `false`.
